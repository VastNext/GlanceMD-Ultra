...
(function() {
  ...
  var LOCALES = {
    'zh-CN': {
      ...
      'settings.cliDesc': '安装 gmdu 命令行 shim 到系统 PATH，支持在终端中直接打开工作区',
    ...
    'en': {
      ...
      'settings.cliDesc': 'Install the gmdu CLI shim to system PATH to open workspaces directly from terminal',
