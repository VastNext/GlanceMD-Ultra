...
(function() {
  ...
  var LOCALES = {
    'zh-CN': {
      ...
      'settings.translationInputTargetLanguage': '输入翻译默认目标语言',
      'settings.translationInputTargetLanguageDesc': '直达替换（Alt+Shift+X）写回选区时使用的目标语言，适合"中文输入、译成英文"的场景，与阅读用的默认目标语言互相独立',
      ...
      'command.translate.bubble.replace': '划词气泡：替换选区（错误态为重试）',
      'command.translate.bubble.insert': '划词气泡：插入译文',
      'command.translate.bubble.copy': '划词气泡：复制译文',
      'command.translate.popup.toggle': '语层翻译：翻译当前预览 / 还原原文',
      'command.translate.popup.bilingual': '语层翻译：双语对照呈现',
      'command.translate.popup.replaceMode': '语层翻译：纯译文呈现',
      'commandDesc.translate.bubble.replace': '把气泡中的译文写回编辑器选区；接口出错时同键重试',
      'commandDesc.translate.bubble.insert': '把气泡中的译文以空行追加到选区之后',
      'commandDesc.translate.bubble.copy': '复制气泡中的译文到剪贴板',
      'commandDesc.translate.popup.toggle': '将预览区全文在译文与原文之间一键切换，无需打开翻译浮窗',
      'commandDesc.translate.popup.bilingual': '预览区以双语对照呈现（已翻译时立即复用缓存重渲染）',
      'commandDesc.translate.popup.replaceMode': '预览区以纯译文呈现（已翻译时立即复用缓存重渲染）',
      ...
      'translate.toastTranslating': '正在翻译…',
      'translate.toastReplaced': '已替换选区',
      'translate.toastModeSet': '呈现模式：{mode}（下次翻译生效）',
      ...
      'translate.cmdBubbleReplace': '划词气泡：替换选区（错误态为重试）',
      'translate.cmdBubbleInsert': '划词气泡：插入译文',
      'translate.cmdBubbleCopy': '划词气泡：复制译文',
      'translate.cmdPopupToggle': '语层翻译：翻译当前预览 / 还原原文',
      'translate.cmdPopupBilingual': '语层翻译：双语对照呈现',
      'translate.cmdPopupReplaceMode': '语层翻译：纯译文呈现',
    ...
    'en': {
      ...
      'settings.translationInputTargetLanguage': 'Input Translation Target Language',
      'settings.translationInputTargetLanguageDesc': 'Target language used by direct replace (Alt+Shift+X) when writing the selection back, independent of the reading target language',
      ...
      'command.translate.bubble.replace': 'Bubble: Replace Selection (Retry on error)',
      'command.translate.bubble.insert': 'Bubble: Insert Translation',
      'command.translate.bubble.copy': 'Bubble: Copy Translation',
      'command.translate.popup.toggle': 'LexiLayer: Translate Current Preview / Restore',
      'command.translate.popup.bilingual': 'LexiLayer: Bilingual Mode',
      'command.translate.popup.replaceMode': 'LexiLayer: Translation-only Mode',
      'commandDesc.translate.bubble.replace': 'Write the bubble translation back to the editor selection; retries with the same key on errors',
      'commandDesc.translate.bubble.insert': 'Append the bubble translation after the selection with a blank line',
      'commandDesc.translate.bubble.copy': 'Copy the bubble translation to the clipboard',
      'commandDesc.translate.popup.toggle': 'Toggle the current preview between translated and original, without opening the panel',
      'commandDesc.translate.popup.bilingual': 'Render the preview bilingually (re-uses cached translation instantly)',
      'commandDesc.translate.popup.replaceMode': 'Render the preview as translation only (re-uses cached translation instantly)',
      ...
      'translate.toastTranslating': 'Translating…',
      'translate.toastReplaced': 'Selection replaced',
      'translate.toastModeSet': 'Display mode: {mode} (applies to next translation)',
      ...
      'translate.cmdBubbleReplace': 'Bubble: Replace Selection (Retry on error)',
      'translate.cmdBubbleInsert': 'Bubble: Insert Translation',
      'translate.cmdBubbleCopy': 'Bubble: Copy Translation',
      'translate.cmdPopupToggle': 'LexiLayer: Translate Current Preview / Restore',
      'translate.cmdPopupBilingual': 'LexiLayer: Bilingual Mode',
      'translate.cmdPopupReplaceMode': 'LexiLayer: Translation-only Mode',
