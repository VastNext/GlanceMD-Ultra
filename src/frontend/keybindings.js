(function () {
  ...
  function dispatch(e){if(e.target&&/INPUT|TEXTAREA|SELECT/.test(e.target.tagName))return;var key=normalize(e),map=effective();for(var id in map)if(map[id]===key&&window.Commands&&Commands.has&&Commands.has(id)){e.preventDefault();Commands.run(id);return id;}return null;}
